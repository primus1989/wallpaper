package com.besweety.wallpapers.app;
...
public class AppConst {
	...
	public static final String PICASA_USER = "sharkofdesign";

	// Public albums list url
	public static final String URL_PICASA_ALBUMS = "https://picasaweb.google.com/data/feed/api/user/sharkofdesign?kind=album&alt=json";

	// Picasa album photos url
	public static final String URL_ALBUM_PHOTOS = "https://picasaweb.google.com/data/feed/api/user/sharkofdesign/albumid/_ALBUM_ID_?alt=json";

	// Picasa recenlty added photos url
	public static final String URL_RECENTLY_ADDED = "https://picasaweb.google.com/data/feed/api/user/sharkofdesign?kind=photo&alt=json";
